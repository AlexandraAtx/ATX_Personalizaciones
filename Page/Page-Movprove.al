page 50120 "Movimientos Proveedor List"
{
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
    SourceTable = "Movimientos Proveedor Liq";
    ...
    actions
    {
        area(Navigation)
        {
            action(VendorLedgerEntries)
            {
                ...
                PromotedIsBig = true;
                ToolTip = 'Abre la página de movimientos de proveedor filtrada por el documento actual';
        ...
        area(Processing)
        {
            action(GenerarMovimientos)
            {
                ...
                PromotedCategory = Process;
                PromotedIsBig = true;
                ToolTip = 'Genera los movimientos de proveedor en la tabla';
